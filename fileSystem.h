...
public:
    int iNodeNum = INODENUM;           //total num of i node
    int freeNode = INODENUM;           //num of free i node
    int disk = TOTALGROUPSIZE;        //total num of disk blocks
    int freeDisk = TOTALGROUPSIZE;    //num of free disk blocks
    INodeList iNodeList;
